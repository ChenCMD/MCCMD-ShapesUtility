...
execute as 0-a-17a7-3-2 run scoreboard players operation @s CB03_Core > #to-X CB03_Core
execute as 0-a-17a7-3-2 run scoreboard players operation @s CB03_Core > #to-Y CB03_Core
execute as 0-a-17a7-3-2 run scoreboard players operation @s CB03_Core > #to-Z CB03_Core
execute as 0-a-17a7-3-2 run scoreboard players operation @s CB03_Core *= #10000 CB03_Core
execute as 0-a-17a7-3-2 run scoreboard players operation @s CB03_Core /= #c-max CB03_Core
execute as 0-a-17a7-3-2 run scoreboard players operation @s CB03_Core /= $count CB03_Input
...
execute if score $count CB03_Input >= #t CB03_Core at 0-a-17a7-3-2 run function chenbr_shapes_util:core/bezier/line/quadratic/recursive