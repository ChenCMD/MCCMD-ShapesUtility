...
execute facing entity @s feet run tp @e[limit=1,type=area_effect_cloud,tag=chenbr_shapes_util-output,tag=!chenbr_shapes_util-temp,distance=..0.0001] ~ ~ ~ ~ ~
scoreboard players operation @e[limit=1,type=area_effect_cloud,tag=chenbr_shapes_util-output,tag=!chenbr_shapes_util-temp,distance=..0.0001] SummonOrder = #summon-count Core
