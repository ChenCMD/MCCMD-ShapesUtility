...
execute store result score #from-Y Core run data get entity 0-a-17a7-3-6 Pos[1] 1000
execute store result score #from-Z Core run data get entity 0-a-17a7-3-6 Pos[2] 1000
...
scoreboard players operation #c-max Core > #c-Y Core
scoreboard players operation #c-max Core > #c-Z Core
scoreboard players operation #distance-c Core > #to-X Core
scoreboard players operation #distance-c Core > #to-Y Core
