#> chenbr_shapes_util:core/bezier/line/cubic/draw
# @internal
...
scoreboard players reset #c-max CB03_Core
scoreboard players reset #distance-c CB03_Core
execute store result score #from-X CB03_Core run data get entity 0-a-17a7-3-6 Pos[0] 1000
execute store result score #from-Y CB03_Core run data get entity 0-a-17a7-3-6 Pos[1] 1000
execute store result score #from-Z CB03_Core run data get entity 0-a-17a7-3-6 Pos[2] 1000
...
execute at 0-a-17a7-3-6 facing entity 0-a-17a7-3-1 feet positioned 0.0 0.0 0.0 run tp 0-a-17a7-3-2 ^ ^ ^1 ~ ~
execute store result score #c-X CB03_Core run data get entity 0-a-17a7-3-2 Pos[0] 1000
execute store result score #c-Y CB03_Core run data get entity 0-a-17a7-3-2 Pos[1] 1000
execute store result score #c-Z CB03_Core run data get entity 0-a-17a7-3-2 Pos[2] 1000
scoreboard players operation #to-X CB03_Core -= #from-X CB03_Core
...
scoreboard players operation #c-max CB03_Core > #c-Y CB03_Core
scoreboard players operation #c-max CB03_Core > #c-Z CB03_Core
scoreboard players operation #distance-c CB03_Core > #to-X CB03_Core
scoreboard players operation #distance-c CB03_Core > #to-Y CB03_Core
scoreboard players operation #distance-c CB03_Core > #to-Z CB03_Core
scoreboard players operation #distance-c CB03_Core *= #10000 CB03_Core
scoreboard players operation #distance-c CB03_Core /= #c-max CB03_Core
execute as 0-a-17a7-3-0 at @s facing entity 0-a-17a7-3-5 feet run tp @s ~ ~ ~ ~ ~
execute as 0-a-17a7-3-5 at @s facing entity 0-a-17a7-3-6 feet run tp @s ~ ~ ~ ~ ~
execute as 0-a-17a7-3-6 at @s facing entity 0-a-17a7-3-1 feet run tp @s ~ ~ ~ ~ ~
...
scoreboard players operation #distance-c CB03_Core /= $count CB03_Input
...
execute as 0-a-17a7-3-6 run scoreboard players set @s CB03_Core 0
scoreboard players set #t CB03_Core 0
tp 0-a-17a7-3-2 0-a-17a7-3-0
execute as 0-a-17a7-3-2 at @s run function chenbr_shapes_util:core/bezier/line/cubic/recursive