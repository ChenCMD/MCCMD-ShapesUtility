...
execute store result score #particle-distance Core run data get entity 0-a-17a7-3-0 Pos[1] 100
execute store result score #temp Core run data get entity 0-a-17a7-3-2 Pos[1] 100
...
execute as 0-a-17a7-3-0 at @s run function chenbr_shapes_util:core/line/move_recursive