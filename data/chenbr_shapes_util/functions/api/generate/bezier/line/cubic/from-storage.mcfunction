#> chenbr_shapes_util:api/generate/bezier/line/cubic/from-storage
# @public
# @input
...
data modify entity 0-a-17a7-3-6 Pos set from storage chenbr:shapes_util InputPos[2]
data modify entity 0-a-17a7-3-1 Pos set from storage chenbr:shapes_util InputPos[3]
